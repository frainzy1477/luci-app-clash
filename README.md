<h2 align="center">
 <img src="https://cdn.jsdelivr.net/gh/Dreamacro/clash/docs/logo.png" alt="Clash" width="200">
  ...
  <p align="center">
  <a target="_blank" href="https://github.com/frainzy1477/luci-app-clash/releases/tag/v1.7.4">
    <img src="https://img.shields.io/badge/luci%20for%20clash-v1.7.4-blue.svg"> 	  
  </a>
...
- cd /tmp
- opkg update
- opkg install luci-app-clash_v1.7.4_all.ipk  
- opkg install luci-app-clash_v1.7.4_all.ipk --force-depends
